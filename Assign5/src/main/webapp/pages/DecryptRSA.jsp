...
<title>Decrypt Using RSA</title>
</head>
<body style="background-color: #f2f2f2; text-align: center;">
    <h1 style="color: #333;">Decryption using RSA</h1>
    <form action="DECFileRSA" method="post" enctype="multipart/form-data">
      <label for="PubliKey" style="display: block; margin-bottom: 10px;">Private Key:</label>
